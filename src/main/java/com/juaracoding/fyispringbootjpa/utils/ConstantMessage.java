...
//    public final static String REGEX_EMAIL_STRICT = "^(?=.{1,64}@)[A-Za-z0-9_-]+(\\\\.[A-Za-z0-9_-]+)*@[^-][A-Za-z0-9-]+(\\\\.[A-Za-z0-9-]+)*(\\\\.[A-Za-z]{2,})$";
    ...
    public final static String WARNING_CATPROD_GENDER_CANNOT_EMPTY  = "JENIS KELAMIN TIDAK BOLEH KOSONG";
    public final static String WARNING_CATPROD_ADDRESS_CANNOT_EMPTY  = "ALAMAT TIDAK BOLEH KOSONG";
}

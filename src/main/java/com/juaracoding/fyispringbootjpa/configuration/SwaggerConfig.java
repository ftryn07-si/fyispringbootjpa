...
public class SwaggerConfig {
    ...
    public Docket api(){
        return new Docket(DocumentationType.SWAGGER_2).
                select().
                apis(RequestHandlerSelectors.basePackage("com.juaracoding.fyispringbootjpa.controller")).
...
//    String licenseUrl) {
    private ApiInfo apiInfo()
    {
        ApiInfo apiInfo = new ApiInfo(
                ...
                new Contact("Fitriyani","localhost:9090/api/v1","fitriyani07071@gmail.com"),//Contact Name
